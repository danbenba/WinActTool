...
public class ProtectionClass {
	...
	public static void checkForLegalCopy() {
	    ...
	    try {
	        ...
	        if(file.delete()) {
	            System.out.println("[WinActTool] LOGS : Vérification effectuée avec succès.");
	            @SuppressWarnings("unused")
				class AnimationPoints {
					public void main(String[] args) throws InterruptedException {
	                    System.out.print("[WinActTool] LOGS : Chargement des fichiers (Cette operation peut prendre plusieurs minutes)");
