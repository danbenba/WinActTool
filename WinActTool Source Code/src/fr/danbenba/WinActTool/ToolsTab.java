...
public class ToolsTab {
    ...
    public static VBox CreateToolstab(Stage primaryStage) {
        ...
        VBox button1 = createButton("Uninstall Edge", "Suppression d'application", "edgerv.exe");
        VBox button2 = createButton("Uninstall WD", "Outils pour Windows", "DefenderRemover.exe");
        VBox button3 = createButton("Activer Détails", "Outil du registre", "verbose.reg");
        VBox button4 = createButton("AutoRefresh", "Outil pour les fénéants", "AutoRefresh.exe");
