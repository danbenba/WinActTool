...
public class main extends Application {
    ...
    static void launcherMain(Stage primaryStage) {
        ...
        String privilegeLevel = isAdmin ? "Administrator" : "User";
        ...
        if (isAdmin) {
            ...
            Tooltip tooltip = new Tooltip("This Application requires administrator privilege.");
        ...
        if (isAdmin) {
            Label adminMessageLabel = new Label("Administrator Mode Enabled");
        ...
        for (Tab tab : new Tab[] { tabActWin, tabCracker, tabPKI, TabTools, tabAbout }) {
        ...
        tabPane.getTabs().addAll(tabActWin, tabCracker, tabPKI, TabTools, tabAbout);
